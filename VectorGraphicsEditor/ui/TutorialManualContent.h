...
// ---------------------------------------------------------------------
// @brief   双语 HTML 教程手册的静态内容
// @details 包含英文和简体中文两版完整 HTML 手册，内容覆盖界面布局、
//          绘图工具用法、选择与编辑、文件操作、快捷键等。
//          通过 tutorial::kManualHtmlEn 和 tutorial::kManualHtmlZh
//          两个常量字符串提供，由 TutorialDialog 按需加载。
// @layer   ui
// =====================================================================
